...
class TestVarasto(unittest.TestCase):
    def setUp(self):
        ...
        self.virhevarasto = Varasto(-10, 5)
        self.virhevarasto2 = Varasto(5, -2)
    ...
    def test_konstruktori_luo_virhevaraston(self):
        self.assertAlmostEqual(self.virhevarasto.tilavuus, 0)

    def test_uudella_virhevarastolla_oikea_saldo(self):
        self.assertAlmostEqual(self.varasto.saldo, 0)

    def test_uudella_virhevarastolla2_oikea_saldo(self):
        self.assertAlmostEqual(self.varasto.saldo, 0)
